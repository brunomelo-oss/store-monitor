...
export const mockApps: App[] = [
  ...
  { id: 11, name: 'Humaitá', region: 'Brasil', city: 'Humaitá', state: 'AM', googleAccount: 'humaita@edu.am.gov.br', appleAccount: 'humaita@gocase.com', playStore: { status: s('REJECTED'), version: '0.8.0', lastUpdate: '2026-05-15T09:00:00Z' }, appStore: { status: s('PENDING'), version: '', lastUpdate: '' }, installations: 0, rating: 0, pinned: false, sortOrder: 11, issues: [{ store: 'google', status: 'rejected', date: '2026-05-15T09:00:00Z' }] },
