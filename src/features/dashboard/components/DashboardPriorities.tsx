...
export function DashboardPriorities({ priorities, publishedApps, inReviewApps, needsAttentionApps, totalApps }: DashboardPrioritiesProps) {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-3">
      <div className="lg:col-span-2 sasi-card rounded-xl p-5">
        ...
        <div className="space-y-2">
          {priorities.length === 0 ? (
            <div className="text-center py-8 text-sm text-muted-foreground/60">{t('dashboard.noPendingItems')}</div>
          ) : (
            priorities.map(app => {
      ...
      <div className="sasi-card rounded-xl p-5">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/admin/connections" className="text-xs text-blue-600 dark:text-blue-400 hover:underline">
