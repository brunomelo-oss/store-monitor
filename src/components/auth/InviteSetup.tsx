...
export function InviteSetup({ email, onSuccess, onBack }: InviteSetupProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="text-center text-lg font-semibold text-white">Criar Senha</div>
      <div className="text-xs text-zinc-500 mb-1">E-mail</div>
      <div className="px-4 py-3 rounded-lg bg-white/[0.06] text-white text-sm font-semibold break-all">
        {email}
      </div>
